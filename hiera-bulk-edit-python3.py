...
# Comments from Guillem Liarte
'''
- using python3 instead of 2
- replaced print statements 
- commented out import for compiler.ast
'''
...
#from compiler.ast import flattena -> flatten works as is in pythion 3.x
